...
import 'package:hac_final/Contractor/screens/sidedrawer.dart';
import 'package:hac_final/Contractor/screens/workdata.dart';
import 'package:hac_final/Contractor/services/auth.dart';
...
class _HomeState extends State<Home> {
  final CAuthService _authService = CAuthService();
          ...
          return Card(
            ...
            child: ListTile(
              ...
              subtitle: Column(
                children: <Widget>[
                  Text(
                    'Amount: ₹${work.data['Proposed Amount']}',
                    style: TextStyle(
                      fontFamily: 'Lora',
                      fontStyle: FontStyle.normal,
                      fontWeight: FontWeight.bold,
